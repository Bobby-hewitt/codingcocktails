...
class CssContainer extends Component {
  ...
  render() {
    return (
        ...
        <Comment lang='css' comment="Lets start by styling the page header. The '#' refers to the ID from the HTML whereas a ‘.’  refers to a class. This element is 'fixed' in the top left corner. This means it doesn't move when you scroll. Try adding a border color (code uses American English spellings) of 'grey', a border-width of '2px' and a border-style of 'solid'. Lets also set the background-color to 'white'"/>
	   ...
	   <Comment lang='css' comment="You can turn bullet points off by setting list style type to 'none', or you can change these to numbers by setting it to 'decimal'."/>
	    ...
	    <Comment lang='css' comment="Now lets style the footer. You know how to do this now! Have you noticed the semi colon at the end of everything you type? Semicolons denote the end of a statement. "/>
