  ...
  render() {
    return (
    	...
    	<Comment lang='css' comment="You can select items with their tags too.  try setting the size and color of the <h3> tags"/>	
    		<CssDeclarator changeCss={this.changeCss.bind(this)} item="headersCss" declarator="h3" properties={this.props.headersCss}/>
	    ...
	    <Comment lang='css' comment="Set a colour for the method text.  You can also set a width in % if you don't want the writing to run the entire width of the screen.  Again, lets ignore 'position' for the time being"/>
	    	<CssDeclarator changeCss={this.changeCss.bind(this)} hasPosition={true} item="methodsCss" declarator="#methodsContainer" properties={this.props.methodsCss}/>
	    <Comment lang='css' comment="Let's do the same with the ingredients"/>
	    	<CssDeclarator changeCss={this.changeCss.bind(this)} hasPosition={true} item="ingredientsCss" declarator="#ingredientsContainer" properties={this.props.ingredientsCss}/>
